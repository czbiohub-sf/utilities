    ...
    "resources" : [
      {
        ...
        "path" : "script.sh",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/utilities/utilities/src/demux/spaceranger_mkfastq/"
      }
    ],
    "description" : "Demultiplex raw sequencing data",
    "usage" : "spaceranger mkfastq --input /path/to/bcl --sample_sheet \\\\\n  sample_sheet.csv --output fastqs --reports reports\n",
    "status" : "enabled",
...
thisDefaultProcessArgs = [
  ...
  "container" : {
    "registry" : "docker.io",
    "image" : "czbiohub/demux_spaceranger_mkfastq",
    "tag" : "0.1.2"
  },
  "tag" : "$id"
}'''),
