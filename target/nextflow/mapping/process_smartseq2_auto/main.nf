// process_smartseq2_auto main_build
// 
    ...
    "argument_groups" : [
      {
        ...
        "arguments" : [
          ...
          },
          {
            ...
            "default" : [
              "(.*/)?(.*)(_[A-P][0-9]{1,2})(_.*)?_R[12](_001)?.fastq.gz"
            ],
            "required" : false,
            "direction" : "input",
            "multiple" : false,
          ...
          },
          {
            ...
            "description" : "Which groups from the fastq regex to use as the cell ID. \nAssuming a fastq file is detected at `dir1/dir2/sample_id_A1_foo_R1.fastq.gz`,\nthe outputs of several regexes is listed:\n\n  * `$1$2$3` -> `dir1/dir2/sample_id_A1`\n  * `$1$2$3$4` -> `dir1/dir2/sample_id_A1_foo`\n",
            "info" : {
              "hidden" : true
            },
            "default" : [
    ...
    "resources" : [
      {
        ...
        "path" : "main.nf",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/utilities/utilities/src/mapping/process_smartseq2/",
        "entrypoint" : "auto"
      }
    ],
