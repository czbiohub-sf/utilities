...
thisConfig = processConfig(jsonSlurper.parseText('''{
    ...
    "resources" : [
      {
        ...
        "path" : "script.py",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/utilities/utilities/src/mapping/spaceranger_count/"
      }
    ],
  ...
  "info" : {
    ...
    "platform" : "nextflow",
    "viash_version" : "0.7.3",
    "git_commit" : "0021673e8db57790df4a194ef9c581927a9b8413",
...
par = {
  'input_fastqs': $( if [ ! -z ${VIASH_PAR_INPUT_FASTQS+x} ]; then echo "r'${VIASH_PAR_INPUT_FASTQS//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'input_tif': $( if [ ! -z ${VIASH_PAR_INPUT_TIF+x} ]; then echo "r'${VIASH_PAR_INPUT_TIF//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'reference_genome': $( if [ ! -z ${VIASH_PAR_REFERENCE_GENOME+x} ]; then echo "r'${VIASH_PAR_REFERENCE_GENOME//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'output': $( if [ ! -z ${VIASH_PAR_OUTPUT+x} ]; then echo "r'${VIASH_PAR_OUTPUT//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'id': $( if [ ! -z ${VIASH_PAR_ID+x} ]; then echo "r'${VIASH_PAR_ID//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'sample': $( if [ ! -z ${VIASH_PAR_SAMPLE+x} ]; then echo "r'${VIASH_PAR_SAMPLE//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'lanes': $( if [ ! -z ${VIASH_PAR_LANES+x} ]; then echo "int(r'${VIASH_PAR_LANES//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi ),
  'slide': $( if [ ! -z ${VIASH_PAR_SLIDE+x} ]; then echo "r'${VIASH_PAR_SLIDE//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi )
}
meta = {
...
thisDefaultProcessArgs = [
  ...
  "container" : {
    "registry" : "docker.io",
    "image" : "czbiohub/mapping_spaceranger_count",
    "tag" : "0.1.2"
  },
  "tag" : "$id"
}'''),
