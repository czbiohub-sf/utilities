...
thisConfig = processConfig(jsonSlurper.parseText('''{
    ...
    "resources" : [
      {
        ...
        "path" : "script.py",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/utilities/utilities/src/mapping/spaceranger_count/config.vsh.yaml"
      }
    ],
  ...
  "info" : {
    ...
    "platform" : "nextflow",
    "viash_version" : "0.7.0",
    "git_commit" : "ad0386df03d60cece1c72054e63a16ff43f6edff",
...
thisDefaultProcessArgs = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "czbiohub/mapping/spaceranger_count",
    "tag" : "main_build"
  },
  "tag" : "$id"
}'''),
