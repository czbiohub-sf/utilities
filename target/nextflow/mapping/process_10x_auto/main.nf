        ...
        "arguments" : [
          {
            "type" : "file",
            "name" : "--reference",
            "description" : "The path to Cell Ranger reference index. This input can be either a `.tar.gz` file or a directory. Using a directory will be slightly faster.\nExample: /path/to/reference.tar.gz.\n",
            "example" : [
              "reference.tar.gz"
            ],
            "must_exist" : true,
    ...
    "resources" : [
      {
        ...
        "path" : "main.nf",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/utilities/utilities/src/mapping/process_10x/auto.vsh.yaml",
        "entrypoint" : "auto"
      }
    ],
...
VIASHMAIN
nextflow run . -main-script "$tempscript" -entry auto
'''
